...
(function() {
  var GOLDEN_RATIO, HALF_PI, Orbit, TWO_PI, acosh, angleInPlane, circularToEscapeDeltaV, cosh, crossProduct, ejectionAngle, goldenSectionSearch, insertionToCircularDeltaV, newtonsMethod, normalize, projectToPlane, sign, sinh;
  ...
  Orbit.transferDetails = function(transfer, originBody, t0, initialOrbitalVelocity) {
    var a, burnDirection, e, ejectionDeltaV, ejectionDeltaVector, ejectionInclination, initialOrbitRadius, mu, n0, normalDeltaV, nu0, p0, positionDirection, progradeDeltaV, progradeDirection, radialDeltaV, referenceBody, rsoi, theta, v0, v1, vsoi;
    referenceBody = originBody.orbit.referenceBody;
    nu0 = originBody.orbit.trueAnomalyAt(t0);
    p0 = originBody.orbit.positionAtTrueAnomaly(nu0);
    v0 = originBody.orbit.velocityAtTrueAnomaly(nu0);
    ...
    if (initialOrbitalVelocity) {
      ...
      if (numeric.dot(crossProduct(burnDirection, progradeDirection), n0) < 0) {
